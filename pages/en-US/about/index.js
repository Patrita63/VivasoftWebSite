  ...
  return (
    ...
    <div className='h-full bg-primary py-32 text-center xl:text-left bg-gradient-to-r from-primary via-black/30 to-black/10'>
      ...
      <div className='container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6'>
        {/* text */}
        <div className='flex-1 flex flex-col justify-center xl:pt-0 pt-40'>
          <motion.h2
          ...
          >
             For over 10 years it has been a consolidated reality in the IT sector, specialized in teaching and creating solutions based on the <span className='text-secondary text-bold'>Microsoft Power Apps, Power BI and Power Automate.</span>
          </motion.p>
          {/* counters */}
          <motion.div
