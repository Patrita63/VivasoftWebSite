      ...
      <div className='container mx-auto'>
        <div className='flex flex-col xl:flex-row gap-x-8'>
          ...
          <div className='text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0  pt-60'>
            ...
            >
              We dedicate ourselves with passion and professionalism to the training of professionals and companies, helping them to transform their ideas into concrete solutions. 
            </motion.p>
          </div>
